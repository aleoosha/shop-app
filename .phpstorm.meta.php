...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\Repositories\ProductRepositoryContract' => \App\Repositories\Elasticsearch\ProductRepository::class,
...
'database.redis.horizon.backoff_cap','database.redis.horizon.options.prefix','elastic.client.default','elastic.client.connections.default.hosts','elastic.scout_driver.refresh_documents',
...
'queue.connections.redis.retry_after','queue.connections.redis.block_for','queue.connections.redis.after_commit','queue.connections.deferred.driver','queue.connections.background.driver',
...
'scout.typesense.import_action','scout.elastic.hosts','services.postmark.key','services.ses.key','services.ses.secret',
...
'horizon.jobs.show','horizon.index','products.search','storage.local',);
        registerArgumentsSet('views', 
'products.index','welcome','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'APP_PORT','LOG_CHANNEL','LOG_LEVEL','DB_CONNECTION','FORWARD_DB_PORT',
'DB_PORT','DB_HOST','DB_DATABASE','DB_USERNAME','DB_PASSWORD',
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','FORWARD_REDIS_PORT',
'QUEUE_CONNECTION','SCOUT_DRIVER','ELASTIC_HOST','SCOUT_QUEUE','SCOUT_ELASTIC_HOST',
